    ...
    <title>Corporate Insurance | ICICI Lombard</title>
        ...
        <script type="text/javascript" src="/ruxitagentjs_ICA7NVfqrux_10307250124095659.js" data-dtconfig="rid=RID_-1169978098|rpid=692987471|domain=icicilombard.com|reportUrl=/rb_277d0916-de11-45e0-a5dc-287f905e237a|app=5b008aa14c2ff8df|cuc=sdnyn5e6|mel=100000|expw=1|featureHash=ICA7NVfqrux|dpvc=1|lastModification=1755684112741|tp=500,50,0|rdnt=1|uxrgce=1|agentUri=/ruxitagentjs_ICA7NVfqrux_10307250124095659.js"></script><link rel="shortcut icon" href="../assets/images/icici1.png">
        <!-- libraries link -->
    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme menu-none d-sm-block d-md-none">
        ...
        <ul class="menu-inner py-1">
            ...
            <li class="menu-item other-menu"> 
                       <a href='/Portal/CPTLogin' class="menu-link"> <div data-i18n="Email">Login</div></a> 
            ...
            <div class="container">
                ...
                <div class="navbar-collapse" id="navbarNav">
                    <div class="mobMenuWrapper" id="mobMenu">
                        <ul class="navBar">
                            <li>
                                <a id="becomeAgent" class="sliding-link" href='/'>Home</a>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
                                    Products
                    ...
                    <a href='/Portal/ContactUs' class="btn contact-us-btn">Contact Us</a>
                        ...
                        <a href='/Portal/CPTLogin' class="btn  ml-2 login-btn" style="text-transform: capitalize;">Login</a>
                ...
                <div class="toggle-content toggle-content-mob">
                    ...
                    <div class="d-flex flex-row align-content-center">
                        ...
                        <a href='/Portal/CPTLogin' class="btn login-btn-mob ml-3">Login</a>
    ...
    <div class="container banner">
        ...
        <div class="banner-slider" id="bannerSlider">
            ...
            <div class="banner-slide">
                ...
                <img src="../assets/images/Indian-Risk-Report-mob.jpg" class="d-none d-md-block img-fluid" alt="Slide 3">
                <img src="../assets/images/Indian-Risk-Report-web.jpg" class="d-block d-md-none w-100" alt="Slide 3">
                <div class="banner-caption thirdBtnSize">
                    <a class="btn know-more-btn" href='/Portal/India_risk_report'>Know More</a>

                </div>
                <div>
                    <a href="https://www.icicilombard.com/docs/default-source/default-document-library/icici-lombard-irm-india-risk-report-2024-edition-2-0.pdf" class="btn cash-mobile" class="btn click-here-btn">Click Here</a>
                </div>
            </div>
            ...
            <div class="col-12">
              <div class="counter-figure-wrapper">
                <div class="counter-content-wrapper">
                  <h2 class="counter-numbers" data-number="2000">₹71.06B</h2>
                  <p>Gross written Premium</p>
                  <img src="../assets/images/icons/lines.svg" class="img-fluid lines-graphics" alt="lines">
                </div>
                <div class="counter-content-wrapper">
                        <h2 class="counter-numbers" data-number="6000">92.1%</h2>
                  <p>Claim Settlement</p>
                  <img src="../assets/images/icons/lines.svg" class="img-fluid lines-graphics" alt="lines">
                </div>
                <div class="counter-content-wrapper">
                  <h2 class="counter-numbers" data-number="3000">13.6%</h2>
                        <p>Market Share</p>
                  <img src="../assets/images/icons/lines.svg" class="img-fluid lines-graphics" alt="lines">
                </div>
                <div class="counter-content-wrapper">
                  <h2 class="counter-numbers" data-number="3000">20K+</h2>
                  <p>Customers</p>
                </div>
              </div>
            </div>
            ...
            <div class="accordion-item">
                ...
                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                    ...
                    <div class="accordion-body">
                        <div class="row faq-gray-txt">
                            <div class="col-md-12 m-b-20">
                                <p>If you have a grievance or query, here&rsquo;s how you can seek help:</p>
                                <ul class="disc-list-f">
                                    <li><strong>Call us</strong>: Toll-free number 1800 2666</li>
                                    <li><strong>Visit our website</strong>: Go to the &ldquo;Grievance Redressal&rdquo; section in the Customer Support area at&nbsp;<a href="https://www.icicilombard.com/" class="faqlink">ICICI&nbsp;Lombard</a>.</li>
                                    <li><strong>Visit a branch</strong>: Contact the nearest ICICI Lombard branch office.</li>
                                </ul>
                                <p>If you&rsquo;re unsatisfied with the resolution:</p>
                                <ul class="disc-list-f">
                                    <li>You can escalate your concern to the&nbsp;<strong>IRDAI</strong>&nbsp;through the&nbsp;<a href="https://bimabharosa.irdai.gov.in/" class="faqlink">Bima&nbsp;Bharosa&nbsp;Portal</a>&nbsp;or call the&nbsp;<strong>IRDAI Grievance Call Centre</strong>&nbsp;at 1800 4254 732 / 155255.</li>
                                    <li>
                                        Alternatively, you can approach the&nbsp;<strong>Insurance Ombudsman</strong>. Details are available on the&nbsp;<a href="https://irdai.gov.in/" class=" faqlink"">IRDAI&nbsp;website</a>&nbsp;or the&nbsp;<a href="https://www.icicilombard.com/" class="faqlink">ICICI&nbsp;Lombard&nbsp;website</a>.
                                    </li>
                                </ul>
                            </div>
                        </div>
