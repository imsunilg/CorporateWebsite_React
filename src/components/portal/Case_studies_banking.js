          ...
          <div className="industry-section-options top-40f">
            <div className="dropdown industry-list-dropdown">
              ...
              <div className="dropdown-menu pl-3 m-t-20f case-studies-menu">
                ...
                <a className="dropdown-item ICICIMenu mb-2 active" href="/Portal/case_studies_banking ">BANKING &amp; FINANCIAL SERVICES</a>
              ...
              <div className="col-lg-8 industry-info-main text-black">
                <div id="pharma" className="industry-info p-l-0">
                  <div className="industry-info-head text-black" id="data1">
                    ...
                    <img src="../assets/images/banners/bfsi case study.jpg" className="img-fluid m-b-20" />
                    <p>The company is a Large Finance Conglomerate.</p>
                    <p>The aim was to graduate to an integrated, centralized, cost-effective and tech-based wellness program that will be customized and user-friendly for the employees. </p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="col-lg-8 industry-info-main text-black">
                <div id="pharma" className="industry-info p-l-0">
                  <div className="industry-info-head text-black m-t-20" id="data1">
                    ...
                    <p>After analyzing the health data of the employees, the following recommendations were made:</p>
                    <ul className="case-studies-list">
                      <li><span>Health check-up for employees and spouses</span></li>
                      <li><span>Health Risk Assessment</span></li>
                      <li><span>Health sessions</span></li>
                      <li><span>Disease Management Program</span></li>
                      <li><span>Webinars on better health management</span></li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-8 industry-info-main text-black">
                <div id="pharma" className="industry-info p-l-0">
                  <div className="industry-info-head text-black m-t-20" id="data1">
                    ...
                    <ul className="case-studies-list">
                      <li>
                        Physical copies of medical reports were provided to individuals as well as on the portal with their wellness scores.Corporate HR was provided a central dashboard of the program usage and key health parameters at an aggregate level.
                      </li>
                      <li>
                        Marketing and program assistance was provided.
                      </li>
                      <li>
                        Implementation of a disease management program was provided to employees with monitored care from our team of experts backed by specialized doctors, assisting many in managing their diabetes levels, blood pressure, and weight.
                      </li>
                    </ul>
                    <h2 style={{fontSize: '30px'}}>Outcome</h2>
                    <ul className="case-studies-list">
                      <li>Significant commercial saving for the client on account of the centralized process, economies of scale and use of technology</li>
                      <li>Employee awareness on the health-related concerns improved significantly; engaging program with good participation of 70%</li>
                    </ul>
                  </div>
                </div>
              </div>
...
export default Case_studies_banking;